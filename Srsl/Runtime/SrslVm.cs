...
public class SrslVm
{
    ...
    public SrslVmInterpretResult Interpret( BinaryChunk mainChunk, Dictionary <string, BinaryChunk > compiledChunks, SymbolTableBuilder.SymbolTableBuilder symbolTableBuilder )
    {
