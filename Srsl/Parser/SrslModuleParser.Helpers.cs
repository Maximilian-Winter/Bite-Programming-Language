...
namespace Srsl.Parser
{
    ...
    public class SrslModuleParser : Parser
    {
            ...
            if (speculate_ternary())
            {
                ...
                switch (node)
                {
                    ...
                    case TernaryOperationNode ternaryOperationNode:
                        ...
                        break;
                    case UnaryPrefixOperation unaryPrefixOperation:
                        assignmentNode.Type = AssignmentTypes.UnaryPrefix;
                        assignmentNode.UnaryPrefix = unaryPrefixOperation;
                        break;
                    case UnaryPostfixOperation unaryPostfixOperation:
        ...
        public UsingStatementNode usingStatement()
        {
            ...
            var alreadyParsed = alreadyParsedRule(MemoizingDictionary, "usingStatement");
            ...
            if (Speculating && alreadyParsed.Result)
            {
                return null;
            }
        ...
        private IContext<ExpressionNode> _ternary()
        {
            if (Speculating)
            {
                logicOr();
